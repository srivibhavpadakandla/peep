...
enum EventType: String, Codable, Hashable, CaseIterable {
    ...
    /// High-level category used for the Activity filter chips.
    enum Category: String, CaseIterable, Hashable {
        case packages, people, animals
        var label: String {
            switch self {
    ...
    var category: Category {
        switch self {
        case .packageArrived, .packageTaken, .packageNotArrived: return .packages
        case .personLoitering, .multipleLoitering, .weaponDetected, .afterHoursActivity: return .people
        case .animalDetected: return .animals
        }
    }
